...
* 百度百科的解释如下：
  ...
  > 计算机科学与技术是一个**计算机系统与网络兼顾**的计算机学科宽口径专业，旨在培养具有良好的科学素养，具有自主学习意识和创新意识，科学型和工程型相结合的计算机专业高水平工程技术人才。

* 人民邮电出版社的《计算机科学概论》（第11版）中有这么两段话：

  > 计算机科学这门学科，是要为计算机设计、计算机程序设计、信息处理、问题的算法解决方案和算法过程本身等主题建立科学的基础。计算机科学既是当今计算机应用的支柱，又是今后计算基础设施的基础。

  可见计算机科学的内容十分广泛。

  > 大多数计算机科学专业的学生在最初的学习中都有这样一个误解，认为计算机科学就是程序设计、网页浏览以及因特网文件共享，因为这基本就是他们所看到的一切。实际上计算机科学远非如此。因此，在入门阶段，学生们需要了解他们主攻的这门学科所涉及内容的广度，这也正是这本书的宗旨。

* 肤浅点来讲就是既能敲代码又能研究怎么敲好代码。

* 与软件工程的区别在于，他们只用写代码，将代码应用与生产生活，而不必深入研究代码背后的原理。

### 1.2 计算机科学与技术学什么？

* 每年学院的教学计划都有所改动，但是大体相同。具体请查看学院官网或新生群文件。
* 专业课有：计算导论与程序设计，高级语言程序设计，计算机系统原理，数据结构与算法，数据库系统，计算机组成与设计，程序设计思维与实践，计算机网络，计算机图形学，操作系统，算法设计与分析，编译原理与技术，计算机体系结构，软件工程与实践等。
* 除了一些基础学科例如高数、英语、大物，基本都是在学如何写代码，如何理解计算机等内容。

## 2.编程环境配置

* 在开始写代码前，我们需要特定的工具：集成开发环境（IDE）或文本编辑器，下面将介绍3款主流编程语言开发环境的配置方法。
* 一般来说，大一新生只需要掌握C/C++的环境配置。而Python和Java虽然没有硬性要求，但是以后总会用到，推荐有兴趣的同学自学。
* 建议在上专业课之前提前熟悉这些编程工具，至少不至于在第一次做实验时蒙圈。
* ~~配置过程中出现的网站有可能需要特殊方法才能流畅访问，在这里不做介绍。~~
...
* 以下内容仅为建议，请结合个人实际情况进行参考。

### 3.1 学习经验

* 首先学好每一门课。~~一定一定不要挂科！！！~~

* 多和有经验的学长交流，会帮助你少踩许多坑。
...
* 在这里主要推荐两门课程，更详细的内容可以通过[github](https://github.com/HYLazy/SDUOJ-Freshman-Programming-Manual)获取
...
* 缺失的一课：
  ...
  网站：[计算机教育中缺失的一课 ](https://missing-semester-cn.github.io/)
...
* 校外访问系统SSL VPN用户使用须知使用须知：[使用须知-山东大学信息化工作办公室 (sdu.edu.cn)](https://www.nc.sdu.edu.cn/SSL_VPN/syxz.htm)

* VPN指虚拟私人网络(virtual private network),是常用于连接中、大型企业或团体间私人网络的通讯方法。它利用隧道协议来达到发送端认证、消息保密与准确性等功能。
* 因为部分山东大学的实用网站，例如SDUOJ，仅限校园网访问，为了使学生因假期、疫情等原因不在校内时访问这些网站，学校提供了山大VPN。通过山大VPN，可以做到在家访问SDUOJ，进行刷题、提交作业等操作。
* 具体的安装使用说明在学校官方的使用须知中很清晰，在此不再赘述。
